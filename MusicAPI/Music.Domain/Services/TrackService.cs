...
namespace Music.Domain.Services
{
    public class TrackService : ITrackService
    {
        ...
        public async Task<Track>  AddTrack(CancellationToken cancellationToken,ExternalTrackOutput externalTrack, int userId)
        {
        ...
        public void AddTrackCollection(CancellationToken cancellationToken, List<ExternalTrackOutput> tracks,int userId)
        {
